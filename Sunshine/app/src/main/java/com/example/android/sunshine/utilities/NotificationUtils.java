...
import com.example.android.sunshine.DetailsActivity;
...
public class NotificationUtils {
    ...
    public static final String[] WEATHER_NOTIFICATION_PROJECTIONS = {
    ...
    public static void notifyUserOFNewWeather(Context context) {
        ...
        Uri todayWeatherUri = WeatherContract.WeatherEntry.builtWeatherUriWithDate(SunshineDateUtils.normalizeDate(System.currentTimeMillis()));


        Cursor todayWeatherCursor = context.getContentResolver().query(
                todayWeatherUri,
                WEATHER_NOTIFICATION_PROJECTIONS,
                null,
                null,
                null
        );
    ...
    private static String getNotificationText(Context context, int weatherID,
        ...
        String shortDesc = SunshineWeatherUtils
